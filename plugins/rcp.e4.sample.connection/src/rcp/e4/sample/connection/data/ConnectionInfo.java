...
public class ConnectionInfo {
	...
	public String toString() {
		return String.format(
				"ConnectionInfo[dbmsType=%s, host=%s, port=%s, connectType=%s, databaseName=%s, user=%s, password=%s, savePassword=%s, jdbcOption=%s, options=%s]",
				dbmsType, host, port, connectType, databaseName, user, password, savePassword, jdbcOption, options);
	}
}
